...
\begin{frame}[fragile]{Não fixe o tamanho de fonte do html}
  ...
  \vspace{0.4cm}
  Ela aparece em muito material antigo e anula o ajuste de tamanho de fonte de
...
\begin{frame}{Exercícios}
  \begin{block}{Entrega}
    Valem nota, no item \emph{Exercícios em sala}. Prazo: \textbf{03/09, às
    23h59}, por \texttt{push} no GitLab.
  \end{block}
  ...
  \begin{itemize}
    ...
    \item a folha que sair daqui recebe o layout no próximo encontro e vai na
          Entrega 1 do trabalho, em 11/09.
  \end{itemize}
\end{frame}
