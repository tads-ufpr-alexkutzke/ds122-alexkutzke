...
\begin{frame}[fragile]{Na prática: o primeiro arquivo}
	No \texttt{catalogo.html}, seu ou do pacote de exemplo da aula:
...
\begin{frame}[fragile]{Na prática: os produtos como dados}
	\begin{enumerate}
	...
	\vspace{0.3cm}
	O número tem que bater com o de cartões na página. No pacote de exemplo, são
	seis; o desconto de cada um fica a seu critério.
...
\begin{frame}[fragile]{Na prática: uma linha por produto}
...
\begin{frame}[fragile]{Na prática: preço com desconto}
...
\begin{frame}[fragile]{Na prática: busca e filtro}
...
\begin{frame}[fragile]{Na prática: valor total}
...
\begin{frame}[fragile]{Na prática: ler o erro}
