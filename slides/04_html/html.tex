...
\begin{frame}{Entrega}
  \begin{block}{Estes exercícios valem nota}
    Compõem o item \textit{Exercícios em sala} da média, e a entrega vai até
    \textbf{27/08, às 23h59}, por \texttt{push} no GitLab.
  \end{block}
...
\begin{frame}{O que a tarefa de hoje prepara}
  ...
  prático}, com prazo em \textbf{11/09}: catálogo de produtos em HTML5 e CSS3.
