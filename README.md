...
* [Pré-prompt para uso de IA generativa](src/00_pre_prompt_para_ia_gen_durante_aulas.md)
* [Sobre Mob Programming para exercícios](src/00_mob_programming.md)
...
* [DOM](src/aula_07_00_dom.md)
* [Exercícios de JS, DOM e Eventos](src/aula_07_01_dom_exercicios.md)
* [Fetch API e JSON](src/aula_07_02_fetch_api.md)
* [jQuery (descontinuada)](src/aula_08_jquery.md)
* [Frameworks Front-end](src/aula_09_frameworks_front_end.md)
* [Programação Back-end](src/aula_10_back_end.md)
* [PHP](src/aula_11_php.md)
* [PHP e Formulários](src/aula_12_php_forms.md)
* [PHP e MySQL](src/aula_13_php_mysql.md)
* [Cookies e Sessions](src/aula_14_cookies_session.md)
